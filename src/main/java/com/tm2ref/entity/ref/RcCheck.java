...
public class RcCheck implements Serializable, Cloneable, PreviousResult {
    ...
    @Column(name = "resumecomplete")
    private int resumeComplete;
    
    
    /**
     * This is the number of competencies included in the top/bottom
     * competencies lists in reports.
     */
    ...
    public boolean getRequiresResumeOrAnyCandidateInputOrSelfRating()
    {
        return getRequiresAnyCandidateInputOrSelfRating() || (rcScript!=null && rcScript.getCollectResumeB());
    }
    ...
    /**
     * data[0]=total data[1]=supervisor/Manager data[2]=peer data[3]=subordinate
    ...
    public void setResumeComplete(int resumeComplete)
    {
